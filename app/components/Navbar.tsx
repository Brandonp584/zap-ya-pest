...
export default function Navbar() {
  ...
  return (
    <nav className={`sticky top-0 z-50 bg-white transition-shadow duration-300 ${scrolled ? "shadow-xl" : "shadow-md"}`}>
          ...
          <div className="relative group">
            ...
            <div className="absolute left-0 top-full mt-2 w-56 z-50
              ...
              <div className="bg-white border border-gray-200 rounded-lg">
                ...
                <Link href="/areas/sunshine-coast" className="block px-4 py-2 hover:bg-gray-100 text-slate-700 transition">
                  Sunshine Coast
                </Link>
                <Link href="/areas/bribie-island" className="block px-4 py-2 hover:bg-gray-100 text-slate-700 transition">
                  Bribie Island
                </Link>
              </div>
            </div>
      ...
      <div className={`md:hidden fixed inset-0 z-40 transition-all duration-300 ${mobileOpen ? "opacity-100 visible" : "opacity-0 invisible"}`}>
        ...
        <div className={`relative bg-white border-t border-gray-200 px-6 py-6 max-w-xs w-full
                         h-full overflow-auto transition-transform duration-300
                         ${mobileOpen ? "translate-x-0" : "-translate-x-full"}`}>

          <Link href="/" className="block text-slate-700 font-medium hover:text-green-600 transition mb-3">Home</Link>
          <Link href="/services" className="block text-slate-700 font-medium hover:text-green-600 transition mb-3">Services</Link>
          ...
          <Link href="/about" className="block text-slate-700 font-medium hover:text-green-600 transition mb-3">About</Link>
          ...
          <div className="space-y-1 mb-3">
            ...
            <div className={`overflow-auto transition-max-height duration-300 ease-out ${mobileAreasOpen ? "max-h-[calc(100vh-10rem)]" : "max-h-0"}`}>
              <div className="mt-2 space-y-1">
                ...
                <Link href="/areas/sunshine-coast" className="block px-2 py-1 hover:bg-gray-100 text-slate-700 rounded transition">
                  Sunshine Coast
                </Link>
                <Link href="/areas/bribie-island" className="block px-2 py-1 hover:bg-gray-100 text-slate-700 rounded transition">
                  Bribie Island
                </Link>
              </div>
            </div>
