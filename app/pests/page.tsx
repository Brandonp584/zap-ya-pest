    ...
    <div className="relative font-sans bg-white overflow-hidden">
      ...
      <div className="hidden md:block absolute top-[420px] right-0 max-w-sm mr-6 z-10">
        <div className="bg-green-600 text-white border border-green-700 rounded-lg shadow-lg p-6 flex flex-col items-start space-y-4">
          ...
          <p className={`${openSans.className} uppercase font-semibold text-sm`}>For Any Pest Treatment (Starting from $220)</p>
          <Link
            href="/contact"
        ...
        <div className="bg-blue-100 rounded-xl shadow-md p-6 mt-6 space-y-4">
          ...
          <div className="flex items-start gap-3">
            <span className="text-blue-600 text-2xl">✅</span>
            <p className={`${openSans.className} text-slate-700 font-medium`}>Guarantee: if pests return during the service period, so do we!</p>
          </div>
          <div className="flex items-start gap-3">
      ...
      {/* Pest Overview Intro */}
      <section className="max-w-5xl px-6 md:px-10 mt-12 space-y-6">
        ...
        <div className="max-w-4xl mx-auto space-y-4 text-slate-700 text-lg md:text-xl leading-relaxed">
          <p>
      ...
      {/* FAQ Section */}
      <section className="space-y-4 max-w-4xl mx-auto px-6 md:px-10 mt-16">
